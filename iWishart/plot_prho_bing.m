% This is to plot prior density of correlations induced by Bingham
...
ha=tight_subplot(1,L_zeta,[0,.07],[.12,.12],[.05,.05]);
lty={'-','-.','--',':','*','+'};
...
for i=1:L_zeta
    ...
    csvwrite('./tmp/setting.csv',[N_samps,zeta(i)]);
...
print(fig,'./result/pri_corr_bing','-dpng','-r0');